...
answers = Answer.create!([
   ...
   {body: 'Балалайка, дорма, гусли', question: questions[15]},

   {body: 'Вокализ', question: questions[16]},
   {body: 'Романс', question: questions[16]},
   {body: 'Танец', question: questions[16]},

   {body: 'Э. Григ', question: questions[17]},
